                    ...
                    <div class="my-5 step" data-wizard-type="step-content" data-wizard-state="current">
                        ...
                        <div class="card-footer">
                            <div class="row">
                                ...
                                <div class="col-lg-8">
                                    ...
                                    <button class="btn btn-danger mr-2" @click.prevent="generatePdf" v-if="orders.length > 0">Generate PDF</button>
                        ...
                        <table class="table table-sm">
                            ...
                            <tr v-for="(order, index) in orders">
                                ...
                                <td> <span v-for="item in order.items"> {{ item.description }} - Qty ({{ item.quantity }}) - </span> <br></td>
                                <td>
                                    <span v-if="order.order_status == 'order_pending'">Order pending </span>
                                   <span v-else-if="order.order_status == 'scheduled'">Scheduled </span>
                                   <span v-else-if="order.order_status == 'awating_dispatch'">Awaiting Dispatch</span>
                                   ...
                                   <span v-else-if="order.order_status == 'not_dispatched'">Not Dispatched </span>
                                   ...
                                   <span v-else>{{order.order_status}} </span>
                                </td>
...
export default {
    ...
    methods: {
        ...
        formSubmit(){
            ...
            formData.append( 'rider_id', this.rider_id);

            let uri = base_url+`v1/report-rider-outscan`;
        ...
        generatePdf(){
            ...
            let uri = base_url + `v1/report-rider-outscan-generate-pdf`;
            axios({
                url: uri,
                method: 'POST',
                responseType: 'blob',
                ...
                link.href = url;
                link.setAttribute('download', 'rider-outscan-report-pdf.pdf');
        ...
        generateExcel(){
            ...
            let uri = base_url + `v1/report-rider-outscan-generate`;
            axios({
                url: uri,
                method: 'POST',
                responseType: 'blob',
                ...
                const link = document.createElement('a');
                link.href = url;
                link.setAttribute('download', 'rider-outscan-report.xls');
                document.body.appendChild(link);
                link.click();
            }).catch(function (error) {
                this.loader = false;
