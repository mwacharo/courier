                    ...
                    <div class="my-5 step" data-wizard-type="step-content" data-wizard-state="current">
                        ...
                        <div class="card-body">
                            <div class="form-group row">
                                <div class="col-lg-4">
                                    <label>Date:</label>
                                    <select class="form-control" v-model="inventory_date" @change.prevent="selectedDate">
                                ...
                                <div class="col-lg-4">
                                    ...
                                    <select class="form-control" v-model="low_count">
                        ...
                        <table class="table table-sm">
                            ...
                            <tr>
                                ...
                                <th title="Field #6">Quantity</th>
                                <th title="Field #7">Low Count</th>
                            ...
                            <tr v-for="(inventory, index) in inventories">
                                ...
                                <td>
                                    <a v-bind:href='base_url_web_admin+"inventory-details/"+inventory.id'>View details</a>
                                </td>
                            </tr>
                            </tbody>
                        </table>
    ...
    export default {
        ...
        methods: {
            ...
            selectedDate(){
                ...
                if(this.inventory_date == 'custom_date'){
                    $('#modalCustomDate').modal('show');
                }else if(this.inventory_date == 'custom_range'){
            ...
            formSubmit(){
                ...
                var inventory_date = this.inventory_date;
                ...
                if(inventory_date == 'custom_range'){
                ...
                let uri = base_url+`v1/report-inventory`;
            ...
            generateExcel(){
                ...
                let uri = base_url + `v1/report-inventory-generate`;
                axios({
                    url: uri,
                    method: 'POST',
                    responseType: 'blob',
                    ...
                    link.href = url;
                    link.setAttribute('download', 'inventory-report-excel.xls');
