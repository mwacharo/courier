<template>
    <div>
        <div class="d-flex justify-content-center">
            <div class="col-8 alert alert-danger text-center" role="alert" v-if="data_error">Operation failed. An error was encountered!</div>
        </div>
                    ...
                    <div class="my-5 step" data-wizard-type="step-content" data-wizard-state="current">
                        ...
                        <table class="table table-sm">
                            ...
                            <tr>
                                ...
                                <th title="Field #7">Trasit Date</th>
                            ...
                            <tr v-for="(order, index) in orders">
                                ...
                                <td class="text-primary" v-if="order.order_status == 'in_transit'"> In Transit</td>
...
export default {
    ...
    methods: {
        ...
        formSubmit(){
            ...
            let uri = base_url+`v1/report-rider-intransit`;
        ...
        let uri = base_url + `v1/report-rider-intransit-generate`;
        axios({
            url: uri,
            method: 'POST',
            responseType: 'blob',
            ...
            link.href = url;
            link.setAttribute('download', 'rider-intransit-report.xls');
      ...
      this.data_error = false;
        }, 2000); // Set the data_error message to false after 3 seconds (3000 milliseconds)
            });
       }
