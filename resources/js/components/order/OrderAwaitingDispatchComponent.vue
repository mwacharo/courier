        ...
        export default {
            ...
            methods: {
                ...
                formSubmit(){
                    ...
                    let uri = base_url+`v1/order-awaiting-dispatch`;
                ...
                generateExcel(){
                    ...
                    const vm = this;
                    let uri = base_url + `v1/order-awaiting-dispatch-generate-excel`;
                    axios({
                        url: uri,
                        method: 'POST',
                        responseType: 'blob',
                        ...
                        link.href = url;
                        link.setAttribute('download', 'order-awaiting-dispatch-excel.xls');
