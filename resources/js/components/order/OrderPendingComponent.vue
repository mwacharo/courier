        ...
        <table class="table table-bordered table-hover table-checkable" id="order_table" style="margin-top: 13px !important">
            ...
            <tr v-for="(order, index) in orders">
                ...
                <td>
                    ...
                    <a href="#" @click.prevent="selectOrderStatus(order)" data-toggle="modal" data-target="#statusModal" v-else-if="order.order_status == 'not_dispatched'">Undispatched</a>
                </td>
                <td>
...
<script>
    ...
    export default {
        ...
        methods: {
            ...
            fetchOrders (){
                let uri = base_url+`v1/order-pending-list`;
                axios.get(uri, {
            ...
            formSubmit(){
                ...
                let uri = base_url+`v1/order-pending-search-page`;
