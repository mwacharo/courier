...
@section('content')
    ...
    <div class="content d-flex flex-column flex-column-fluid" id="kt_content">
        ...
        <div class="d-flex flex-column-fluid">
            ...
            <div class="container">
                <!--begin::Card-->
                <div class="card card-custom col-11">
                    <!--begin::Header-->
                    <div class="card-header flex-wrap border-0 pt-6 pb-0">
                        ...
                        <div class="card-toolbar">
                            ...
                            <a href="{{ route('merchant.order.create') }}" class="btn btn-primary font-weight-bolder">
                    ...
                    <div class="card-body">
                        <!--begin: Datatable-->
                        <merchant-order-component merchant_id="{{ Auth::user()->id }}"></merchant-order-component>
                        <!--end: Datatable-->
                    </div>
                    <!--end::Body-->
                </div>
