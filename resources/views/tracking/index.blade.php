                    ...
                    <div class=" container ">
                        <div class="d-flex justify-content-between align-items-center pt-25 pb-35">
                            <h3 class="font-weight-bolder text-dark mb-0">
                                Boxleo Order ({{ strtoupper($order->order_no) }})
                            </h3>
                            <div class="d-flex">
                                ...
                                <div class="col-lg-12">
                                    ...
                                    <table class="table table-bordered table-checkable" id="kt_datatable">
                                        <thead>
                                            <tr>
                                                <th>Order No</th>
                                                <th>{{ strtoupper($order->order_no) }}</th>
                                            </tr>
                                        </thead>
                                            <tbody>
                                                <tr>
                                                    <th>Sender Name</th>
                                                    <td>{{ strtoupper($order->sender_name) }}</td>
                                                </tr>
                                                <tr>
                                                    <th>Receiver Name</th>
                                                    <td>{{ strtoupper($order->receiver_name) }}</td>
                                                </tr>
                                                <tr>
                                                    <th>Receiver Address</th>
                                                    <td>{{ strtoupper($order->receiver_address) }}</td>
                                                </tr>
                                                <tr>
                                                    <th>Order Status</th>
                                                ...
                                                <tr>
                                                    <th>Status Date</th>
                                                    <td>{{ strtoupper($order->status_date) }}</td>
                                                </tr>
                                                <tr>
                                                    <th>Special Instructions</th>
                                                    <td>{{ strtoupper($order->special_instruction) }}</td>
                                                </tr>
                                            </tbody>
