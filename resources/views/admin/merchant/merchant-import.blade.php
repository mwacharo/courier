        ...
        <div class="subheader py-2 py-lg-4 subheader-solid" id="kt_subheader">
            <div class="container-fluid d-flex align-items-center justify-content-between flex-wrap flex-sm-nowrap">
                ...
                <div class="d-flex align-items-center flex-wrap mr-2">
                    <!--begin::Page Title-->
                    <h5 class="text-dark font-weight-bold mt-2 mb-2 mr-5">Import Merchants</h5>
                    <!--end::Page Title-->
                    <!--begin::Actions-->
                            ...
                            <div class="card-body p-0">
                                <div class="row justify-content-center py-8 px-8 py-lg-15 px-lg-10">
                                    <div class="col-xl-12 col-xxl-10">
                                        <form class="form" id="kt_form" method="POST" action="{{ route('admin.merchant.import.upload') }}" enctype="multipart/form-data">
                                            {{ csrf_field() }}
                                                    ...
                                                    <div class="my-5 step" data-wizard-type="step-content" data-wizard-state="current">
                                                        ...
                                                        <div class="form-group row">
                                                            <label class="col-xl-3 col-lg-3 col-form-label">Excel file (xls or xlsx)<br>
                                                                <a href="{{ route('admin.download.merchant.template') }}" class="text-danger">Download template</a>
