                ...
                <div class="card card-custom col-10">
                    ...
                    <div class="card-header flex-wrap border-0 pt-6 pb-0">
                        <div class="card-title">
                            <h3 class="card-label">Branches Management
                                <span class="d-block text-muted pt-2 font-size-sm">Branches management made easy</span>
                            </h3>
                        </div>
                        <div class="card-toolbar">

                            
                            <a href="{{ route('admin.branch.create') }}" class="btn btn-primary font-weight-bolder">
                        ...
                        <table class="datatable datatable-bordered datatable-head-custom" id="kt_datatable">
                            ...
                            @foreach($branches as $branch)
                                <tr>
                                    ...
                                    <td>
                                        @can('branch-details')
                                            <a href="{{ route('admin.branch.details', ['id' => $branch['id']] ) }}">View details</a>
                                        @endcan
                                    </td>
