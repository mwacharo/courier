        ...
        <rect fill="#000000" opacity="0.3" x="10" y="17" width="7" height="2" rx="1"/>
                                ...
                                <li class="nav-item mr-3">
                                    <a class="nav-link" data-toggle="tab" href="#kt_user_edit_tab_3">
                                        ...
                                        <span class="nav-text font-size-lg">Payments</span>
                                    </a>
                                </li>
                                <!--end::Item-->
                    ...
                    <div class="card-body px-0">
                            ...
                            <div class="tab-content">
                                ...
                                <div class="tab-pane show active px-7" id="kt_user_edit_tab_1" role="tabpanel">
                                    <!--begin::Row-->
                                    <order-details-component order_id="{{ $id }}" causer_id="{{ Auth::user()->id }}" change_order_status_date="{{ Auth::user()->can('change-order-status-date') }}" change_order_amount="{{ Auth::user()->can('change-order-amount') }}"></order-details-component>
                                    <!--end::Row-->
                                </div>
                                <!--end::Tab-->
                                <!--begin::Tab-->
                                            ...
                                            <table class="datatable datatable-bordered datatable-head-custom table-striped" id="kt_datatable">
                                                ...
                                                @foreach ($logs as $log)
                                                    <tr>
                                                        ...
                                                        <td>{{ strtoupper($log['admin_name']) }}</td>
