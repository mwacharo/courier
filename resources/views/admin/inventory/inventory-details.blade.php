        ...
        <div class="subheader py-2 py-lg-4 subheader-solid" id="kt_subheader">
            <div class="container-fluid d-flex align-items-center justify-content-between flex-wrap flex-sm-nowrap">
                ...
                <div class="d-flex align-items-center flex-wrap mr-2">
                    <!--begin::Page Title-->
                    <h5 class="text-dark font-weight-bold mt-2 mb-2 mr-5">Inventories</h5>
                    <!--end::Page Title-->
                    <!--begin::Actions-->
                    ...
                    <div class="card-body px-0">
                            ...
                            <div class="tab-content">
                                ...
                                <div class="tab-pane show active px-7" id="kt_user_edit_tab_1" role="tabpanel">
                                    <!--begin::Row-->
                                    <inventory-details-component inventory_id="{{ $id }}" causer_id="{{ Auth::user()->id }}"></inventory-details-component>
                                    <!--end::Row-->
                                </div>
                                <!--end::Tab-->
                                <!--begin::Tab-->
                                            ...
                                            <table class="datatable datatable-bordered datatable-head-custom table-striped" id="kt_datatable">
                                                ...
                                                @foreach ($inventory_histories as $inventory_history)
                                                    <tr>
                                                        ...
                                                        <td>{{ $inventory_history['transaction_type'] }}</td>
