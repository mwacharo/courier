        ...
        <div class="subheader py-2 py-lg-4 subheader-solid" id="kt_subheader">
            <div class="container-fluid d-flex align-items-center justify-content-between flex-wrap flex-sm-nowrap">
                ...
                <div class="d-flex align-items-center flex-wrap mr-2">
                    <!--begin::Page Title-->
                    <h5 class="text-dark font-weight-bold mt-2 mb-2 mr-5">Inventories (Inscan)</h5>
                    <!--end::Page Title-->
                    <!--begin::Actions-->
                            ...
                            <ul class="nav nav-tabs nav-bold nav-tabs-line nav-tabs-line-3x">
                                ...
                                <li class="nav-item mr-3">
                                    <a class="nav-link active" data-toggle="tab" href="#kt_user_edit_tab_1">
                                        ...
                                        <span class="nav-text font-size-lg">Transaction</span>
                                    </a>
                                </li>
                                <!--end::Item-->
                                <!--begin::Item-->
                                <li class="nav-item mr-3">
                                    <a class="nav-link" data-toggle="tab" href="#kt_user_edit_tab_2">
                                        ...
                                        <span class="nav-text font-size-lg">History</span>
                                    </a>
                                </li>
                                <!--end::Item-->
                    ...
                    <div class="card-body px-0">
                            ...
                            <div class="tab-content">
                                ...
                                <div class="tab-pane show active px-7" id="kt_user_edit_tab_1" role="tabpanel">
                                    <!--begin::Row-->
                                    <inventory-inscan-component admin_id="{{ Auth::id() }}"></inventory-inscan-component>
                                    <!--end::Row-->
                                </div>
                                <!--end::Tab-->
                                        ...
                                        <div class="col-10">
                                            <table class="datatable datatable-bordered datatable-head-custom table-striped" id="kt_datatable">
                                                ...
                                                <tr>
                                                    ...
                                                    <th title="Field #2">Item</th>
                                                    <th title="Field #3">Merchant</th>
                                                ...
                                                @foreach ($inventory_histories as $inventory_history)
                                                    <tr>
                                                        <td>{{ strtoupper($inventory_history['sku'])  }}</td>
                                                        <td><a href="{{ route('admin.inventory.details', ['id' => $inventory_history['inventory_id']] ) }}">{{ $inventory_history['name'] }}</a></td>
                                                        <td><a href="{{ route('admin.merchant.details', ['id' => $inventory_history['merchant_id']] ) }}">{{ $inventory_history['merchant_name'] }}</a></td>
                                                        <td>{{ $inventory_history['quantity'] }}</td>
                                                        <td>{{ $inventory_history['balance'] }}</td>
                                                        <td>{{ $inventory_history['created_at'] }}</td>
                                                    </tr>
                                                @endforeach
                                                </tbody>
                                            </table>
