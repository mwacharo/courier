                ...
                <div class="card card-custom col-10">
                    ...
                    <div class="card-header flex-wrap border-0 pt-6 pb-0">
                        <div class="card-title">
                            <h3 class="card-label">Administrators Management
                                <span class="d-block text-muted pt-2 font-size-sm">Administrators management made
                                    easy</span>
                            </h3>
                        </div>
                            ...
                            <tbody>
                                ...
                                @foreach ($admins as $admin)
                                    <tr>
                                        ...
                                        <td>
                                            @can('admin-details')
                                                <a href="{{ route('admin.admin.details', ['id' => $admin->id]) }}">View
                                                    details</a>
                                            @endcan
                                        </td>
