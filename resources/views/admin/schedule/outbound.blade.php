        ...
        <div class="subheader py-2 py-lg-4 subheader-solid" id="kt_subheader">
            <div class="container-fluid d-flex align-items-center justify-content-between flex-wrap flex-sm-nowrap">
                ...
                <div class="d-flex align-items-center flex-wrap mr-2">
                    <!--begin::Page Title-->
                    <h5 class="text-dark font-weight-bold mt-2 mb-2 mr-5">Outbound Schedules</h5>
                    <!--end::Page Title-->
                    <!--begin::Actions-->
                ...
                <div class="card card-custom col-10">
                    ...
                    <div class="card-header flex-wrap border-0 pt-6 pb-0">
                        <div class="card-title">
                            <h3 class="card-label">Outbound Schedules Management
                                <span class="d-block text-muted pt-2 font-size-sm">Outbound Schedules management made easy</span>
                            </h3>
                        </div>
                        <div class="card-toolbar">
                            
                            <a href="{{ route('admin.schedule.outbound.create') }}" class="btn btn-primary font-weight-bolder">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        @can('schedule-details')
                                            <a href="{{ route('admin.schedule.outbound.details', ['id' => $schedule['id']] ) }}">View details</a>
                                        @endcan
                                    </td>
